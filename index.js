...
},{"_css_loader":"../../../../../../.nvm/versions/node/v13.2.0/lib/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../node_modules/vue-hot-reload-api/dist/index.js":[function(require,module,exports) {
var Vue // late bind
var version
...
var data = {
  ...
  // Our series array that contains series objects or in this case series data arrays
  series: [[5, 2, 4, 2, 0, 5, 2, 4, 2, 0, 5, 2, 4, 2, 0, 5, 2, 4, 2, 0, 5, 2, 4, 2, 0, 5, 2, 4, 2, 0]]
};
var _default = {
  data: function data() {
    return {
  ...
  mounted: function mounted() {
    new _chartist.default.Line(this.$refs.chart, data, {
      height: '30vw',
...
exports.default = _default;
  ...
  return _c(
    "k-view",
    { staticClass: "k-moviereviews-view" },
    [
      _c("k-header", [_vm._v("Stats")]),
      _vm._v(" "),
