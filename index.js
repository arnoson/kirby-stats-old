...
},{}],"components/DateRange.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    input: function input(_ref) {
      var from = _ref.from,
          to = _ref.to;
      // Remove timestamp and emit the new dates.
      this.$emit('input', {
        from: from === null || from === void 0 ? void 0 : from.substring(0, 10),
        to: to === null || to === void 0 ? void 0 : to.substring(0, 10)
      });
    }
  }
};
exports.default = _default;
        var $aa4e3a = exports.default || module.exports;
      
      if (typeof $aa4e3a === 'function') {
        $aa4e3a = $aa4e3a.options;
      }
    
        /* template */
        Object.assign($aa4e3a, (function () {
          var render = function() {
  var _vm = this
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$aa4e3a', $aa4e3a);
          } else {
            api.reload('$aa4e3a', $aa4e3a);
          }
        }
...
},{"vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"components/DateShortcuts.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  methods: {
    select: function select(unit) {
      var today = new Date();
      var tomorrow = new Date(new Date().setDate(today.getDate() + 1)); // To include today, we have to look at all data until tomorrow.
...
exports.default = _default;
        var $631d48 = exports.default || module.exports;
      
      if (typeof $631d48 === 'function') {
        $631d48 = $631d48.options;
      }
    
        /* template */
        Object.assign($631d48, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$631d48', $631d48);
          } else {
            api.reload('$631d48', $631d48);
          }
        }
...
},{"vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"../node_modules/chartist/dist/chartist.js":[function(require,module,exports) {
var define;
var global = arguments[3];
...
},{}],"../../../../../../.nvm/versions/node/v13.2.0/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{}],"../../../../../../.nvm/versions/node/v13.2.0/lib/node_modules/parcel-bundler/src/builtins/css-loader.js":[function(require,module,exports) {
...
},{"./bundle-url":"../../../../../../.nvm/versions/node/v13.2.0/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"../node_modules/chartist/dist/chartist.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../../../../../../.nvm/versions/node/v13.2.0/lib/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"components/StatsChart.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  computed: {
    ...
    data: function data() {
      var fromTime = new Date(this.period.from).getTime() / 1000;
      var toTime = new Date(this.period.to).getTime() / 1000;
      var _this$logs = this.logs,
          hourly = _this$logs.hourly,
          daily = _this$logs.daily;
      var labels = [];
      var views = [];
      var visits = [];
      var interval = this.interval;

      for (var time = fromTime; time < toTime; time += interval) {
        var _ref, _ref2, _hourly$time, _daily$time, _ref3, _ref4, _hourly$time2, _daily$time2;

        labels.push(new Date(time * 1000).getHours());
        views.push((_ref = (_ref2 = hourly === null || hourly === void 0 ? void 0 : (_hourly$time = hourly[time]) === null || _hourly$time === void 0 ? void 0 : _hourly$time.views) !== null && _ref2 !== void 0 ? _ref2 : daily === null || daily === void 0 ? void 0 : (_daily$time = daily[time]) === null || _daily$time === void 0 ? void 0 : _daily$time.views) !== null && _ref !== void 0 ? _ref : 0);
        visits.push((_ref3 = (_ref4 = hourly === null || hourly === void 0 ? void 0 : (_hourly$time2 = hourly[time]) === null || _hourly$time2 === void 0 ? void 0 : _hourly$time2.visits) !== null && _ref4 !== void 0 ? _ref4 : daily === null || daily === void 0 ? void 0 : (_daily$time2 = daily[time]) === null || _daily$time2 === void 0 ? void 0 : _daily$time2.visits) !== null && _ref3 !== void 0 ? _ref3 : 0);
      }
      ...
      return {
        ...
        series: [{
          value: views,
          className: 'ct-series-views'
        }, {
          value: visits,
          className: 'ct-series-visits'
        }]
      };
    }
  },
  watch: {
    data: function data(value) {
      ...
      (_this$chart = this.chart) === null || _this$chart === void 0 ? void 0 : _this$chart.update(value);
    }
  },
  mounted: function mounted() {
    this.chart = new _chartist.default.Line(this.$refs.chart, this.data, {
      height: '100%',
      lineSmooth: _chartist.default.Interpolation.none({
        fillHoles: true
      }),
      showArea: true,
      axisX: {// labelOffset: {
  ...
  methods: {
    onMouseMove: function onMouseMove(_ref5) {
...
exports.default = _default;
        var $7ef2a8 = exports.default || module.exports;
      
      if (typeof $7ef2a8 === 'function') {
        $7ef2a8 = $7ef2a8.options;
      }
    
        /* template */
        Object.assign($7ef2a8, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$7ef2a8', $7ef2a8);
          } else {
            api.reload('$7ef2a8', $7ef2a8);
          }
        }
...
},{"chartist":"../node_modules/chartist/dist/chartist.js","chartist/dist/chartist.css":"../node_modules/chartist/dist/chartist.css","_css_loader":"../../../../../../.nvm/versions/node/v13.2.0/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"components/View.vue":[function(require,module,exports) {
"use strict";
...
var _DateRange = _interopRequireDefault(require("./DateRange.vue"));

var _DateShortcuts = _interopRequireDefault(require("./DateShortcuts.vue"));

var _StatsChart = _interopRequireDefault(require("./StatsChart.vue"));
...
var _default = {
  components: {
    ...
    DateShortcuts: _DateShortcuts.default,
    StatsChart: _StatsChart.default
  },
  data: function data() {
    return {
      id: 'home',
  ...
  methods: {
    updateStats: function updateStats() {
      ...
      var id = 'home';
      var _this$period = this.period,
          from = _this$period.from,
          to = _this$period.to;
      this.$api.get("stats/".concat(id, "/").concat(from, "/").concat(to, "/daily")).then(function (data) {
...
exports.default = _default;
        var $3c2d9f = exports.default || module.exports;
      
      if (typeof $3c2d9f === 'function') {
        $3c2d9f = $3c2d9f.options;
      }
    
        /* template */
        Object.assign($3c2d9f, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    "k-view",
    { staticClass: "kirbystats-view" },
    [
      _c(
        "k-header",
        [
          _vm._v("\n    Stats for /" + _vm._s(_vm.id) + "\n    "),
          _c("date-shortcuts", {
            on: {
      ...
      _vm._v(" "),
      _c("stats-chart", {
        attrs: { logs: _vm.logs, period: _vm.period, resolution: "daily" }
      })
    ],
    1
  )
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$3c2d9f', $3c2d9f);
          } else {
            api.reload('$3c2d9f', $3c2d9f);
          }
        }
...
},{"./DateRange.vue":"components/DateRange.vue","./DateShortcuts.vue":"components/DateShortcuts.vue","./StatsChart.vue":"components/StatsChart.vue","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
},{"./components/View.vue":"components/View.vue"}],"../../../../../../.nvm/versions/node/v13.2.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../../../../.nvm/versions/node/v13.2.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)